...
export default function Home() {
  return (
    ...
    <div className='flex justify-between'>
      <div>
      <h1 className=" text-2xl font-bold  text-gray-700 :text-black md:text-4xl mt-3">
        <span className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-600">Blaze Beacon</span> Forest Fire Bot.</h1>
      <p className="text-lg text-gray-800 :text-gray-700">Detect forest fires in real-time, and monitor updates of fire with Mapping Tools.</p>
      </div>
      <div>
...
<form className="flex items-center max-w-5xl mt-4">   
    ...
    <div className="relative w-full">
        ...
        <input tabIndex={-1} type="text" id="voice-search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 placeholder:text-gray-600" placeholder="Search Forests, National Parks..." required/>
...
<div key={area.name} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow ">
    ...
    <div className="p-5">
            <h5 className="mb-2 text-xl font-bold tracking-tight text-gray-700 ">{area.name}</h5>
        
        <a href="vishwakarma-institude-of-technology" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
            Monitor Data
