...
export default function VIT(){
   ...
   useEffect(() => {
      ...
      const modal2 = new Modal($modalElement, modalOptions);
...
<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 :bg-gray-800">
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="#" data-modal-target="modalEl" data-modal-toggle="modalEl"  class="text-sm flex items-center p-2 text-gray-900 rounded-lg :text-white bg-green-200 hover:bg-green-400 :hover:bg-gray-700">
            {/* <svg aria-hidden="true" class="w-6 h-6 transition duration-75 :text-gray-400 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg> */}
               <span class="flex-1 ml-3 whitespace-nowrap flex">D1 - Temp(32`C) & Humidity(68)</span>
            </a>
         </li>
         <li>
            <a href="#" data-modal-target="modalEl2" data-modal-toggle="modalEl2" class="text-sm flex items-center p-2 text-gray-900 rounded-lg :text-white bg-gray-200 hover:bg-gray-300 :hover:bg-gray-700">
            <svg aria-hidden="true" class="w-6 h-6 transition duration-75 :text-gray-400 text-gray-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z"></path><path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z"></path></svg>
   ...
   <div id="modalEl" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative w-full max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <iframe width="450" height="260" className="mr-4 mt-6 p-2" src="https://thingspeak.com/channels/2100842/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&title=Temperature&type=line"></iframe>

            <iframe width="450" height="260" className="mr-4  p-2"  src="https://thingspeak.com/channels/2100842/charts/3?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&title=Smoke&type=line"></iframe>

            <iframe width="450" height="260" className=" p-2" src="https://thingspeak.com/channels/2100842/charts/2?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=60&title=Humidity&type=line"></iframe>
...
<div id="modalEl2" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="p-6 space-y-6">
                <p class="text-base leading-relaxed text-gray-500">
                    This device is currently offline or may not have installed. contact @BlazeBeaconTeam for any issues.
                </p>
            </div>
