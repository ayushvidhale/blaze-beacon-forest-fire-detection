...
export default function Login() {
    return (
        <>
        <div class="h-screen bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-8 px-4">
        
                    <div class="flex flex-col items-center justify-center">
                        <img src="/logo.png" alt="" class=" w-44 h-44" />
                        ...
                        <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 ">
                            ...
                            <div class="w-full flex items-center justify-between py-5">
                                ...
                                <div class="mt-8 w-full ">
                                    <a href="\" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full px-44">Continue</a>
                                </div>
                        </div>
                    </div>
                </div>
